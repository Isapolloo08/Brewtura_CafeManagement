...
export function AddCategoryModal({ isOpen, onClose, onSaveCategory }) {
    ...
    <ModalPortal>
      ...
      <div className="w-full max-w-md glass-card rounded-3xl p-6 space-y-6 border border-white/60 text-[#3C2A21]">
        <div className="flex items-center justify-between border-b border-amber-900/10 pb-4">
          <div>
            <h3 className="font-heading font-extrabold text-xl text-[#3C2A21]">Add New Category</h3>
            <p className="text-xs text-amber-900/60 font-medium">Create a new menu category group</p>
          </div>
